...
namespace MechanicsForum.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProblemId,AnsweredBy,Answer,MediaPath,AnswerDate,ModifiedDate")] Answers answers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProblemId,AnsweredBy,Answer,MediaPath,AnswerDate,ModifiedDate")] Answers answers)
        {
            if (ModelState.IsValid)
            {
